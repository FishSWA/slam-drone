...
int main(int argc, char **argv)
{
    ...
    printf("[POSEGRAPH]: cv::FONT_HERSHEY_SIMPLEX...\n");
    auto msg1 = ros::topic::waitForMessage<sensor_msgs::CameraInfo>("/run_subscribe_msckf/loop_intrinsics", ros::Duration(ros::DURATION_MAX));
    ...
    auto msg2 = ros::topic::waitForMessage<nav_msgs::Odometry>("/run_subscribe_msckf/loop_extrinsic", ros::Duration(ros::DURATION_MAX));
    ...
    ros::Subscriber sub_vio1 = n.subscribe("/run_subscribe_msckf/odomimu", 2000, vio_callback);
    ros::Subscriber sub_vio2 = n.subscribe("/run_subscribe_msckf/loop_pose", 2000, vio_callback_pose);
    ros::Subscriber sub_image = n.subscribe("/camera/infra1/image_rect_raw", 2000, image_callback);
    ros::Subscriber sub_pose = n.subscribe("/run_subscribe_msckf/poseimu", 2000, pose_callback);
    ros::Subscriber sub_extrinsic = n.subscribe("/run_subscribe_msckf/loop_extrinsic", 2000, extrinsic_callback);
    ros::Subscriber sub_intrinsics = n.subscribe("/run_subscribe_msckf/loop_intrinsics", 2000, intrinsics_callback);
    ros::Subscriber sub_point = n.subscribe("/vins_estimator/keyframe_point", 2000, point_callback);
    ros::Subscriber sub_margin_point = n.subscribe("/run_subscribe_msckf/points_msckf", 2000, margin_point_callback);
